...
cover:
  hidden: true
faq:
  - q: "布林通道比特幣策略為什麼回測好但實盤差？"
    a: "回測使用收盤價成交，忽略滑點（0.3-0.8%）、情緒行情的指標滯後性，以及趨勢中的假回歸信號，導致實盤表現與回測差距巨大。"
  - q: "比特幣牛市趨勢適合用布林通道嗎？"
    a: "不適合。牛市裡BTC可沿上軌連走數月均值不回歸，此時做空信號幾乎全部虧損，勝率僅33%。"
  - q: "如何改善布林通道策略在比特幣的表現？"
    a: "加入市場狀態偵測，用ADX判斷趨勢強度、帶寬百分位過濾交易環境，只在橫盤震盪時啟用均值回歸邏輯。"
  - q: "比特幣量化交易需要考慮哪些市場狀態？"
    a: "主要分為牛市趨勢、熊市下跌、橫盤震盪三種市況，BB策略僅在橫盤期表現穩定，其他兩種需順勢或關閉信號。"
hidden: true
