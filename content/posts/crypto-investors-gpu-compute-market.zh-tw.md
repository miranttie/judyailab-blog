...
延伸閱讀：加密挖礦算力金融化：從抵押貸款到存量吞噬從礦業公司融資角度說明算力如何成為金融資產；[算力金融化：比特幣礦業從挖幣到華爾街的生存轉型](/posts/hashrate-financialization-mining-transformation/)補充了礦企轉型的完整路徑；[Tether 做 AI 了 — QVAC Fabric 讓你用手機訓練大型語言模型](/posts/tether-qvac-fabric-edge-ai/)展示了加密公司進入 AI 算力基礎設施的另一個方式。
