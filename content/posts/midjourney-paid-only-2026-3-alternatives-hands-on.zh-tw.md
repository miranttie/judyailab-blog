...
## Midjourney 把免費試用收掉了，這件事比想像中更微妙

Midjourney 已經全面收費。所有方案都是訂閱制，月繳或年繳，預設自動續訂，最低從 Basic Plan 起跳，往上是 Standard、Pro、Mega 共四個 tier [Source: https://docs.midjourney.com/hc/en-us/articles/30246098951821-Comparing-Midjourney-Plans]。

對已經把 Midjourney 當主力的設計工作室來說，這事不痛不癢。月費對他們是工具成本，跟買 Adobe 一樣。
...
**SeaArt**——每日提供免費 credit，介面類似 Civitai 的精簡版，社群模型數量龐大。AI Photo Labs 2026 年的 SeaArt 評測指出它「特別適合 anime、manga、stylized illustration 美學」+「龐大的社群訓練模型庫」 [Source: https://aiphotolabs.com/reviews/seaart-ai-review-is-it-worth-it-in-2026/]，做華語社群、二次元風格內容相對穩定 [Source: https://www.seaart.ai/]。

**另外值得提的**：Google ImageFX（用 Imagen 4，每日免費額度寬鬆，對寫實場景幾乎跟 Midjourney 打平）是 2026 年最被低估的免費選項 [Source: https://www.gamsgo.com/blog/midjourney-free]。但因為它沒有 API、商用條款也綁 Google Workspace，這篇不放進主比較，當有人需要純免費寫實照片時可以加進考量。

## 五個場景拆解，差異比想像中明顯

把五個典型 solopreneur 行銷素材場景（IG 貼文圖、Blog 封面、Logo 草稿、產品 mockup、銷售頁 hero）對照三款工具的官方說明與社群評測，會發現強弱項分得很開——不是「誰比較好」的問題，是「誰適合做什麼」。

**IG 貼文圖**這種需要快速產量、風格一致的場景，SeaArt 出圖速度快、免費額度撐得起每天發文的節奏，但細節質感在社群討論中普遍認為比不上 Flux。
...
**SeaArt**——用 Google 帳號登入，首頁直接有 prompt 輸入框，貼中文進去按生成，幾分鐘內看到結果。

**Ideogram**——註冊後選 Free 方案，介面比 Midjourney 直觀，直接在輸入框打英文 prompt；需要文字時用引號包起來（例：`a poster with "Launch Week" in bold`）。

**Flux**——最快路徑是 Replicate.com，找 flux-schnell 模型，註冊送的 credit 可以跑幾十張。介面偏工程師取向，但功能單純 [Source: https://replicate.com/black-forest-labs/flux-schnell]。
